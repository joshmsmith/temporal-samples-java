...
public class HelloChildSignal {
  ...
  public interface GreetingWorkflow {
    ...
    @SignalMethod
    void sendGreeting(String moreGreeting);
  }
  ...
  public static class GreetingWorkflowImpl implements GreetingWorkflow {
    ...
    public String getGreeting(String name) {
      ...
      if (g1.equals(g2)) return g1;
      else return g2;
    }

    @Override
    public void sendGreeting(String moreGreeting) {
      gotGreeting = true;
    }
  }
